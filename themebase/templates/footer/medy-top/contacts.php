<div class="footer__contact">
    ...
    <ul>
        <li class="contact__item">
            <a href="#">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/medyplus/icon-footer-address.png" alt="">
                <div class="contact__sub">Lorem Ipsum has been the industry's standard</div>
            </a>
        </li>
        <li class="contact__item">
            <a href="mailto:contact@medic.com">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/medyplus/icon-footer-email.png" alt="">
                <div class="contact__sub">contact@medic.com</div>
            </a>
        </li>
        <li class="contact__item">
            <a href="tel:+841234567891">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/medyplus/icon-footer-phone.png" alt="">
                <div class="contact__sub">+84 (1) 234 567 891</div>
            </a>
        </li>
        <li class="contact__item social__media">
            <a href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
            <a href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
            <a href="https://myaccount.google.com/"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
